...
export default function LessonCard({ lesson }) {
  ...
  const realLesson = LESSONS.find((l) => l.title === lesson.title);
  const to = realLesson ? `/learn/${realLesson.slug}` : "/learn";

  return (
    <Link to={to} className={`rounded-2xl bg-gradient-to-br ${lesson.tone} p-5 shadow-[0_14px_36px_rgba(15,23,42,.045)] ring-1 ring-slate-200/80 transition duration-300 hover:-translate-y-1 hover:shadow-[0_20px_44px_rgba(15,23,42,.075)]`}>
