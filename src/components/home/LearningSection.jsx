...
import { ArrowRight, LineChart, BriefcaseBusiness, ShieldCheck, Globe2 } from "lucide-react";
  ...
  return (
    <section className="mx-auto mt-8 max-w-[1660px] px-5 sm:px-8 lg:px-12">
      <SectionTitle
        ...
        action={<Link to="/blogs" className="flex items-center gap-3 text-[14px] font-black text-emerald-800">Explore Lessons <ArrowRight size={18} /></Link>}
      />
