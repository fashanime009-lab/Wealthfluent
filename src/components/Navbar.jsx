    ...
    <header className="sticky top-0 z-50 border-b border-slate-800 bg-[#061225] text-white shadow-sm">
      <div className="mx-auto flex h-[70px] max-w-[1518px] items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-12 text-sm font-medium text-slate-100 md:flex">
          <Link to="/calculators" className="hover:text-blue-300">
            Calculators
          </Link>

          <Link to="/tools" className="hover:text-blue-300">
            Tools
          </Link>

          <Link to="/quizzes" className="hover:text-blue-300">
            FinQuiz
          </Link>
        ...
        <div className="flex items-center gap-4">
          <Link
            to="/wealth-dashboard"
            className="hidden rounded-md border border-slate-600 px-7 py-3 text-sm font-semibold text-white transition hover:border-blue-400 sm:block"
          >
            Login
          </Link>
          ...
          <Link
            to="/sip-calculator"
            className="rounded-md bg-blue-500 px-7 py-3 text-sm font-semibold text-white shadow-[0_0_20px_rgba(59,130,246,.35)] transition hover:bg-blue-600"
          >
            Get Started
          </Link>
        </div>
