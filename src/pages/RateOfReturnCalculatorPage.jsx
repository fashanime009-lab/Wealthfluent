...
<span>{currency}100,000,000</span>
          ...
          <div className="mt-16 space-y-10">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 p-8">
              <h2 className="text-2xl font-bold text-slate-800 mb-4">How Is Annualized Return Calculated?</h2>
              <p className="text-slate-500 leading-relaxed">
                This calculator solves the compound growth formula for the rate
                itself, given a known start and end value:
              </p>
              ...
              <p className="text-slate-500 leading-relaxed mt-4">
                For example, ₹10,000 growing to ₹50,000 over 5 years works out to
                an annualized return of about 37.97% — a single number that
                describes the average annual growth needed to turn the first
                figure into the second, regardless of how bumpy the actual
                year-by-year path was.
              </p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">CAGR (Compound Annual Growth Rate)</h3>
                  <p className="text-slate-500 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">Absolute vs. Annualized Returns</h3>
                  <p className="text-slate-500 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">Risk and Return</h3>
                  <p className="text-slate-500 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">Inflation-Adjusted Returns</h3>
                  <p className="text-slate-500 leading-relaxed">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 p-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-slate-700">Is this the same as CAGR?</h3>
                  <p className="text-slate-500 leading-relaxed">
                    Yes — annualized rate of return and CAGR describe the same
                    calculation: the constant yearly growth rate that would take a
                    present value to a future value over a given number of years.
                  </p>
                </div>
              </div>
            </div>
