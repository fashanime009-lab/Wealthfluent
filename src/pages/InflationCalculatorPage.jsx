        ...
        faqSchema([
          {
            ...
            "answer": "Inflation rates vary by country and over time. Many developed economies have historically targeted around 2%, while emerging economies may experience higher inflation rates. However, inflation can vary significantly based on economic conditions."
          },
          {
            "question": "How does inflation affect my savings?",
            "answer": "Inflation reduces the purchasing power of your savings. If your savings earn a return lower than inflation, your real wealth decreases over time. This is why it's important to invest in assets that beat inflation."
          },
          {
            "question": "Which investments beat inflation?",
            "answer": "Historically, equities (stocks), real estate, and gold have beaten inflation over the long term. Fixed deposits and bonds typically offer returns that may or may not beat inflation depending on the interest rate environment."
          },
          {
            "question": "Should I use the same inflation rate for every goal?",
            "answer": "No \u2014 healthcare and education costs have historically risen faster than general inflation in many economies. Use a higher rate for those specific goals rather than one blanket assumption across your entire plan."
          }
        ]),
      ]}
      />
