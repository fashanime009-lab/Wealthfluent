  ...
  return (
    <>
      <Seo
        ...
        faqSchema([
          {
            "question": "How do I determine my annual increase percentage?",
            "answer": "A good starting point is to match the average inflation rate (the average inflation rate in your country) plus your expected income growth. Many investors use 10% as a reasonable target for annual increase in retirement investments."
          },
          {
            "question": "What should I include in my retirement investments?",
            "answer": "Include all investments earmarked for retirement, such as mutual funds (SIPs), retirement accounts, mutual funds, stocks, bonds, ETFs, and other long-term investments, stocks, bonds, and any other long-term savings vehicles."
          },
          {
            "question": "How often should I update my tracker?",
            "answer": "It's recommended to update your tracker at least annually, or whenever you make a significant contribution to your retirement investments. Regular updates help you stay on top of your progress."
          }
        ]),
      ]}
      />
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-16">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 p-6 md:p-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                ...
                <div className="flex items-center gap-4 flex-1 max-w-xs">
                  <input
                    ...
                    className="flex-1 h-2 bg-emerald-100 rounded-lg appearance-none cursor-pointer accent-emerald-700"
                  />
                  <span className="text-sm font-semibold text-emerald-700 min-w-[50px] text-right">
                    {annualIncrease}%
                  </span>
                </div>
                <button
                  onClick={recalculateTargets}
                  className="text-sm text-emerald-700 hover:text-emerald-900 font-medium underline-offset-2 hover:underline"
                >
                  Recalculate Targets
                </button>
              </div>
                    ...
                    >
                      ...
                      <td className="py-2 px-3">
                        <input
                          ...
                          className="w-full max-w-[180px] ml-auto block rounded-xl border border-slate-200 bg-slate-50 px-3 py-1.5 text-sm font-medium text-slate-700 text-right focus:outline-none focus:ring-2 focus:ring-emerald-600 focus:border-transparent"
                          placeholder="0"
                        />
                      </td>
                      <td className="py-2 px-3">
            ...
            <div className="mt-4">
              <button
                onClick={addRow}
                className="inline-flex items-center gap-2 text-sm text-emerald-700 hover:text-emerald-900 font-medium transition"
              >
            ...
            <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/50">
                ...
                <p className="text-xl font-bold text-emerald-700">{currency}{formatCurrency(totals.totalActual)}</p>
              </div>
              <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200/50">
          ...
          <div className="mt-16 space-y-10">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">Disciplined Saving</h3>
                  <p className="text-slate-500 leading-relaxed">
                    Regular tracking encourages consistent saving and helps you identify gaps early so you can adjust your strategy.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">Inflation Adjustment</h3>
                  <p className="text-slate-500 leading-relaxed">
                    The annual increase feature helps you account for inflation, ensuring your investments keep pace with rising costs.
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-emerald-700 mb-2">Motivation</h3>
                  <p className="text-slate-500 leading-relaxed">
