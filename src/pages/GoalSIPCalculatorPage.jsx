  ...
  return (
    <>
      <Seo
        ...
        faqSchema([
          {
            "question": "What if I can't afford the required monthly SIP?",
            "answer": "Extend the duration if your goal allows it, look for a realistic (not overly optimistic) higher return via equity exposure for long horizons, or split the goal into a smaller near-term target and a larger stretch target."
          },
          {
            "question": "Should I increase my SIP every year?",
            "answer": "A step-up SIP \u2014 increasing your contribution annually in line with income growth \u2014 can meaningfully shorten how long it takes to reach a goal, or let you reach a larger goal with the same starting contribution."
          },
          {
            "question": "Is the expected return guaranteed?",
            "answer": "No \u2014 this is a planning estimate, not a promise. Market-linked investments carry real risk, and actual returns will vary year to year even if the long-term average is close to your assumption."
          }
        ]),
      ]}
      />
