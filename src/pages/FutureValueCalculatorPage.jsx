...
export default function FutureValueCalculatorPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Future Value Calculator – Compound Interest Growth</title>
        <meta
          name="description"
          content="Calculate the future value of your investments with compound interest. See how your money grows with annual additions and compounding."
        />
        <meta
          name="keywords"
          content="future value calculator, compound interest, investment growth, wealth calculator"
        />
      </Helmet>
          ...
          <div className="mt-16 space-y-10">
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-slate-200/60 p-8">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-600 mb-2">Regular Contributions</h3>
                  <p className="text-slate-500 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-600 mb-2">Time Horizon</h3>
                  <p className="text-slate-500 leading-relaxed">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-600 mb-2">Rate of Return</h3>
                  <p className="text-slate-500 leading-relaxed">
