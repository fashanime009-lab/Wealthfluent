        ...
        faqSchema([
          {
            ...
            "answer": "EMI depends on loan amount, interest rate, and repayment duration using standard amortization formulas."
          },
          {
            "question": "Does longer loan tenure reduce EMI?",
            "answer": "Longer tenure generally reduces monthly EMI but may increase total interest paid."
          },
          {
            "question": "Which loan has lowest EMI?",
            "answer": "Lower EMIs depend on lower interest rates, smaller loan amounts, and longer repayment periods."
          },
          {
            "question": "Does prepaying a loan reduce EMI or tenure?",
            "answer": "Most lenders let you choose: reduce the tenure while keeping the EMI the same (saves the most total interest), or reduce the EMI while keeping the original tenure. Shortening the tenure is usually the better move if you can afford the current EMI."
          },
          {
            "question": "Is a fixed or floating interest rate better for EMI?",
            "answer": "Fixed rates keep your EMI unchanged for the loan's life but are usually priced higher upfront. Floating rates track a benchmark and can rise or fall, which changes your EMI (or tenure) over time \u2014 most long-tenure loans like home loans are floating."
          }
        ]),
      ]}
      />
