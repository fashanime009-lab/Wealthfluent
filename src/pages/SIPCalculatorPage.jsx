        ...
        faqSchema([
          {
            ...
            "answer": "A good SIP amount depends on income, financial goals, and investment horizon."
          },
          {
            "question": "Is SIP better than FD?",
            "answer": "SIPs offer market-linked growth potential, while fixed deposits provide stable fixed returns."
          },
          {
            "question": "Can SIP create long-term wealth?",
            "answer": "Long-term SIP investing combined with compounding can significantly grow wealth over time."
          },
          {
            "question": "What happens if I miss a SIP installment?",
            "answer": "Most mutual funds simply skip that month without penalty \u2014 your SIP continues from the next scheduled date. Repeated missed installments over several months can sometimes trigger an auto-cancellation, so check your specific fund's policy."
          },
          {
            "question": "Should I stop my SIP when markets fall?",
            "answer": "Generally no \u2014 a falling market means your fixed SIP amount buys more units at a lower price, which is the entire point of rupee-cost averaging. Stopping during a downturn is one of the most common ways investors damage their own long-term returns."
          }
        ]),
      ]}
      />
