        ...
        faqSchema([
          {
            ...
            "answer": "It remains a widely used starting point, though some planners now suggest a more conservative 3.25-3.5% for very long retirements (40+ years) given today's valuations and lower expected bond returns compared to when the original research was done."
          },
          {
            "question": "Does this account for taxes on withdrawals?",
            "answer": "No \u2014 this is a pre-tax projection. Depending on which account types your investments sit in, actual withdrawals may be taxed, meaning your real-world FIRE number could need to be somewhat higher than shown here."
          },
          {
            "question": "What if my freedom score is below 100%?",
            "answer": "You have three levers: increase your monthly investment, push back your target retirement age, or reduce your target annual expenses (which also lowers your FIRE number, since it's 25\u00d7 annual expenses)."
          }
        ]),
      ]}
      />
