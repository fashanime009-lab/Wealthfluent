        ...
        faqSchema([
          {
            ...
            "answer": "Starting early allows investments more time to grow through the power of compounding. The earlier you start, the smaller the monthly investments needed."
          },
          {
            "question": "How much retirement corpus is enough?",
            "answer": "Retirement corpus depends on lifestyle goals, inflation, expenses, and expected retirement age. A common rule is to have 20-30 times your annual expenses."
          },
          {
            "question": "What is the 4% rule in retirement?",
            "answer": "The 4% rule suggests withdrawing 4% of your retirement corpus annually to ensure funds last for 30 years."
          },
          {
            "question": "Does this calculator account for inflation?",
            "answer": "No \u2014 the projected corpus is in nominal (today's rupee) terms. Use the Inflation Calculator alongside this one to see what that corpus is actually worth in real purchasing power by the time you retire."
          },
          {
            "question": "Should my SIP amount stay fixed until retirement?",
            "answer": "Not necessarily \u2014 a step-up SIP that increases with your income each year typically reaches a larger corpus than a flat SIP of the same starting amount, since later increases still get years of compounding before retirement."
          }
        ]),
      ]}
      />
