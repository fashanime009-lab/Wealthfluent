            ...
            <div className="space-y-8 text-slate-600 leading-relaxed">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 ml-2">
                  ...
                  <li>
                    <span className="font-medium text-slate-700">Locally Stored Data</span> –
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 ml-2">
                  <li>
                    ...
                    and — only if you accept our cookie banner — advertising (all are bound
              ...
              <div>
                ...
                <p>
                  ...
                  <Link to="/settings" className="text-emerald-700 hover:underline">
                    Settings
                  </Link>.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mb-3">
                  FINAIW itself does not set tracking cookies. The only cookies used on this
                  site are Google AdSense's advertising cookies, and only if you accept them
                  in the cookie banner. If you decline, no ad cookies are set and the site
